...
if ($_POST) {
   ...
   $sql = "UPDATE media SET image = '$picture',title = '$tit',p_date = '$pdat',media_type = '$type',description = '$des',isbn = '$nbsi',a_first_name = '$fname', a_last_name = '$lname',  publisher= '$pub',p_address= '$addr', p_type = '$typep', availability = '$avail' WHERE id = {$id}" ;
   if($connect->query($sql) === TRUE) {
       echo  "<h4>Successfully Updated! You will be redirected in 4 seconds!</h4><hr>";
       header ("Refresh: 4; url=../index.php");
       echo "<a href='../update.php?id=" .$id."'><button class='btn btn-dark' type='button'>Back</button></a><br><hr>";
