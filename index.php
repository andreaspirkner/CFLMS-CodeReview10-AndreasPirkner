                ...
                <tbody>
                    ...
                    if($result->num_rows > 0) {
                        ...
                        echo  "<tr>
                                ...
                                <td>" .$row['publisher']."</td>
                                <td><a href='update.php?id=" .$row['id']."'><button class='btn btn-dark border border-dark' type='button'>Edit</button></a><hr>
                                <a href='info.php?id=" .$row['id']."'><button class='btn btn-success border border-dark' type='button'>Info</button></a>
                                </td>
                                <td><a href='delete.php?id=" .$row['id']."'><button class='btn btn-danger border border-dark' type='button'>Delete</button></a></td>
                            </tr>" ;
                        }
                     } else  {
